...
#define SIZE_X				 960		// 設定遊戲畫面的解析度為960x720
...
#define GAME_STATE			 2			// Game State 數量
#define MAX_MAP_COUNT		 3			// 地圖數量 數量
#define KING_STEP_SIZE		 5			// King 每步移動距離
#define KING_JUMP_SIZE_X	 9			// King 跳躍每步 X 距離
#define KING_JUMP_MAX_Y		 18			// King 跳躍每步 Y 距離
#define KING_HIT_SIZE_X		 4			// King 反彈時每步 X 距離
/////////////////////////////////////////////////////////////////////////////
...
enum KING_STATES {
	KING_STATE_RIGHT_STAND,
	KING_STATE_LEFT_STAND,
	KING_STATE_RIGHT_WALK,
	KING_STATE_LEFT_WALK,
	KING_STATE_CHARGE,
	KING_STATE_RIGHT_JUMP,
	KING_STATE_LEFT_JUMP,
	KING_STATE_RIGHT_FALL,
	KING_STATE_LEFT_FALL,
	KING_STATE_RIGHT_HIT,
	KING_STATE_LEFT_HIT
};
